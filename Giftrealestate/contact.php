        ...
        <div class="container mx-auto px-4">
            <div class="relative group">
                <div class="rounded-3xl overflow-hidden shadow-lg border border-gray-100 h-[450px]">
                    <iframe 
                        id="office-map"
                        src="<?php echo !empty($settings['map_iframe_url']) ? htmlspecialchars($settings['map_iframe_url']) : 'https://www.openstreetmap.org/export/embed.html?bbox=38.7513,9.0084,38.7619,9.0180&layer=mapnik&marker=9.01323,38.75661'; ?>" 
